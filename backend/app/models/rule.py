...
class StoryRule(Base):
    ...
    stories = relationship("Story", back_populates="rule")
...
class StoryTemplate(Base):
    ...
    style: Mapped[str] = mapped_column(String(32), index=True, nullable=False)
    ...
    stories = relationship("Story", back_populates="template")
