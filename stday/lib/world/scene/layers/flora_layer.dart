...
class FloraLayer extends WorldLayer {
  ...
  void render(Canvas canvas) {
    ...
    for (final f in state.flora) {
      ...
      switch (f.kind) {
        case FloraKind.tree:
          _drawThemedTree(canvas, p, f.growth, wind, biome);
        ...
        case FloraKind.bush:
          _drawThemedBush(canvas, p, f.growth, state.island.style.grass, biome);
  ...
  void _drawThemedBush(
      Canvas canvas, Offset base, double growth, Color color, String biome) {
    if (biome == 'volcanic_ridge' || biome == 'storm_lighthouse') {
